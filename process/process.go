...
func (p *Process) createStdoutLogger() logger.Logger {
	...
	fileNameWithTimestamp := p.config.GetBool("stdout_logfile_timestamp_suffix", false)
...
func (p *Process) createStderrLogger() logger.Logger {
	...
	fileNameWithTimestamp := p.config.GetBool("stderr_logfile_timestamp_suffix", false)
